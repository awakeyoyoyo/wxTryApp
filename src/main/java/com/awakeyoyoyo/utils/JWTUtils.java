...
public class JWTUtils {
    ...
    public String createJWT(String open_id,long ttlMillis) throws Exception {
        ...
        JwtBuilder builder = Jwts.builder() // 这里其实就是new一个JwtBuilder，设置jwt的body
            ...
            //    .setIssuer(issuer)          // issuer：jwt签发人
                .setSubject("wxapp")        // sub(Subject)：代表这个JWT的主体，即它的所有人，这个是一个json格式的字符串，可以存放什么userid，roldid之类的，作为什么用户的唯一标志。
   ...
   /* public static void main(String[] args) {
        ...
        try {
            ...
            String openId="123";
            String jwt = util.createJWT(openId,Constant.JWT_TTL);
            ...
            System.out.println(c.get("open_id", String.class));
